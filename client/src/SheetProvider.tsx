...
export class SheetProvider extends React.Component<{}, State> {
  public state = {
  ...
  public render() {
    const children = React.Children.map(this.props.children, (child: React.ReactElement<SheetProviderProps>) => {
